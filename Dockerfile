...
RUN stack install --resolver=$RESOLVER brick-2.2 vty-6.1 vty-crossplatform-0.4.0.0 fsnotify-0.4.1.0 text-zipper-0.13 vty-unix-0.2.0.0 hledger-lib-1.32.2 hledger-1.32.2 hledger-ui-1.32.2 hledger-web-1.32.2
...
RUN stack install --resolver=$RESOLVER brick-2.2 vty-6.1 vty-crossplatform-0.4.0.0 text-zipper-0.13 vty-unix-0.2.0.0 hledger-lib-1.32.2 hledger-iadd-1.3.19
