FROM haskell:9.10.2-bullseye as dev
...
WORKDIR /build
RUN git clone --depth 1 --branch 1.50.1 https://github.com/simonmichael/hledger && cd hledger && ls && stack install --verbose hledger hledger-ui hledger-web
