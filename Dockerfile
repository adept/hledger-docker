...
ENV RESOLVER nightly-2024-12-12
ENV LC_ALL=C.UTF-8
...
RUN apt-get update && apt-get install -y --no-install-recommends git python3-pip python3-venv && rm -rf /var/lib/apt/lists && python3 -m venv /usr/app/venv
